...
import { Container, Button, InputGroup, FormControl, ListGroup, Form, Row, Col, Toast } from 'react-bootstrap'
    ...
    <Layout title="組み合わせページ">
      ...
      <Container fluid>
        <h3 className="h3 d-flex justify-content-between">
          <span>ルーム名</span>
          <Button variant="outline-warning" size="sm" onClick={handleUpdate}>
            更新
          </Button>
        </h3>
        <InputGroup hasValidation>
          ...
          <Form.Control type="text" placeholder="精神と時の部屋" required value={title} onChange={handleTilteChange} />
        </InputGroup>
      </Container>
